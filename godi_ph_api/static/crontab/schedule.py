...
def get_static_data():
    ...
    for item in module_list:
        ...
        for i in range(0,100):
            # 计算cpuCore
            item = [random.choice([1,2,4]),random.choice([1,2,4]),random.choice([4,8,16,32,64,128]),random.choice(["128GB","256GB","512GB","1024GB","128TB","256TB","512TB","1024TB"])]
            ...
            if diskData.endswith(" GB"):
                diskNum = float(diskData[0:-3])
            elif diskData.endswith(" TB"):
                diskNum = diskData[0:-3]
